...
begin
  ...
  begin
    cList.Items.AddObject(tmpStr.Names[i],TObject(StrToInt(tmpStr.ValueFromIndex[i])));
    if (StrToIntDef(Result,0) and StrToInt(tmpStr.ValueFromIndex[i])) = StrToInt(tmpStr.ValueFromIndex[i]) then
