...
type
  TZSymbol = record
    ...
    rows : Integer;
    width : Integer;
    primary : array [0..99] of AnsiChar;
...
type
  ...
  function ZBarcode_Create() : PZSymbol; cdecl; external 'zint.dll';
  function ZBarcode_Delete(symbol : PZSymbol) : Integer; cdecl; external 'zint.dll';
  function ZBarcode_Encode(symbol : PZSymbol; input : PAnsiChar) : Integer; cdecl; external 'zint.dll';
  function ZBarcode_Print(symbol : PZSymbol) : Integer; cdecl; external 'zint.dll';
  function ZBarcode_Encode_and_Print(symbol : PZSymbol; input : PAnsiChar) : Integer; cdecl; external 'zint.dll';
  function ZBarcode_Encode_and_Print_Rotated(symbol : PZSymbol; input : PAnsiChar; rotate_angle : Integer) : Integer; cdecl; external 'zint.dll';
