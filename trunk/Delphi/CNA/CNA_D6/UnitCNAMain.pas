...
begin
  ...
  begin
    ...
    try
      ...
      begin
         PropString:=Group.PropertiesSet.Values[Group.PropertiesSet.Names[idxProp]];
        ...
        begin
          ...
          begin
            ...
            begin
              NewVal:=Group.PropertiesSet.Values[Group.PropertiesSet.Names[idxProp]];
              ...
              MyForm.GetNewValue(PropString,
                               ...
                               Group.PropertiesAvailable.Values[Group.PropertiesAvailable.Names[Group.PropertiesAvailable.IndexOfName(Group.PropertiesSet.Names[idxProp])]],
                               true,
                               NewVal,
                               ShowInputBox);
...
begin
  ...
  try
    if (Regi.OpenKey('Software\Borland\Delphi\6.0\Environment Variables\',false)) then
...
begin
  try
    ...
    begin
      FSettings.Profiles.AddProfile(Profiles.Values[Profiles.Names[iProfile]]);
      Profile:=FSettings.Profiles.GetProfile(Profiles.Values[Profiles.Names[iProfile]]);
      if (Profile=nil) then continue;
      Groups.Clear;
      Ini.ReadSectionValues(Profiles.Names[iProfile],Groups);
      for iGroup:=0 to Groups.Count-1 do
      begin
        Profile.AddGroup(Groups.Values[Groups.Names[iGroup]]);
        Group:=Profile.GetGroup(Groups.Values[Groups.Names[iGroup]]);
      ...
      begin
        ...
        begin
          Ini.WriteString('Profile_'+IntToStr(iProfile)+'_Group_'+IntToStr(iGroup)+'_Properties',
                          ...
                          Group.PropertiesSet.Values[Group.PropertiesSet.Names[iPropSet]]);
