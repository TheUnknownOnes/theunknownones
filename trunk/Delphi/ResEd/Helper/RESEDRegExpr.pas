...
{$IFDEF VER210} {$DEFINE D14} {$DEFINE D12} {$DEFINE D11} {$DEFINE D10} {$DEFINE D9} {$DEFINE D7} {$DEFINE D6} {$DEFINE D5} {$DEFINE D4} {$DEFINE D3} {$DEFINE D2} {$ENDIF} // D8
{$IFDEF VER220} {$DEFINE D15} {$DEFINE D14} {$DEFINE D12} {$DEFINE D11} {$DEFINE D10} {$DEFINE D9} {$DEFINE D7} {$DEFINE D6} {$DEFINE D5} {$DEFINE D4} {$DEFINE D3} {$DEFINE D2} {$ENDIF} // D8
{$IFDEF VER230} {$DEFINE D15} {$DEFINE D14} {$DEFINE D12} {$DEFINE D11} {$DEFINE D10} {$DEFINE D9} {$DEFINE D7} {$DEFINE D6} {$DEFINE D5} {$DEFINE D4} {$DEFINE D3} {$DEFINE D2} {$ENDIF} // D8
{$IFDEF VER240} {$DEFINE D15} {$DEFINE D14} {$DEFINE D12} {$DEFINE D11} {$DEFINE D10} {$DEFINE D9} {$DEFINE D7} {$DEFINE D6} {$DEFINE D5} {$DEFINE D4} {$DEFINE D3} {$DEFINE D2} {$ENDIF} // D8

// ======== DRESEDRegExpr.pasefine base compiler options
{$BOOLEVAL OFF}
{$EXTENDEDSYNTAX ON}
{$LONGSTRINGS ON}
{$OPTIMIZATION ON}
