...
function TStream.GetSize: Longint;
  ...
  begin
    ...
    ResID := FindResource(hInstance, PChar(ResName), PChar('PNG'){RT_RCDATA});
...
begin
  ...
  try ResStream := TResourceStream.Create(Instance, Name, PChar('PNG'){RT_RCDATA});
