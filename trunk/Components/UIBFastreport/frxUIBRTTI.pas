...
begin
  ...
  with AScript do  
  begin
    with AddClass(TfrxCustomUIBDatabase, 'TfrxCustomDatabase') do
    begin
      AddProperty('Database', 'TUIBDatabase', GetProp, nil);
    end;

    with AddClass(TfrxUIBDatabase, 'TfrxCustomUIBDatabase') do
    begin
      AddProperty('Database', 'TpUIBDatabase', GetProp, nil);
    end;
