...
type
  ...
  IHxHierarchy = interface(IDispatch)
    ...
    function GetProperty(propid: HxHierarchyPropId; hNode: Integer): Olevariant;
      safecall;
  ...
  IHxTopic = interface(IDispatch)
    ...
    procedure GetInfo(out pTitle: WideString; out pURL: WideString;
      out pLocation: WideString; out pRank: Integer); safecall;
    ...
    function HasAttribute(const Name: WideString; const Value: WideString): Wordbool;
      safecall;
  ...
  IHxTopicDisp = dispinterface
    ...
    procedure GetInfo(out pTitle: WideString; out pURL: WideString;
      out pLocation: WideString; out pRank: Integer); dispid 68102;
  ...
  IHxAttributeList = interface(IDispatch)
    ...
    function EnumAttribute(filter: Integer; options: Integer): IEnumHxAttribute;
      safecall;
  ...
  IHxRegister = interface(IDispatch)
    ...
    procedure RegisterHelpFile(const bstrNamespace: WideString;
      const bstrId: WideString; LangId: Integer;
    ...
    procedure RemoveHelpFile(const bstrNamespace: WideString;
      const bstrId: WideString; LangId: Integer); safecall;
    procedure RegisterHelpFileSet(const bstrNamespace: WideString;
      const bstrId: WideString; LangId: Integer;
      const bstrHxs: WideString; const bstrHxi: WideString;
      const bstrHxq: WideString; const bstrHxr: WideString;
      lHxsMediaId: Integer; lHxqMediaId: Integer;
      lHxrMediaId: Integer; lSampleMediaId: Integer);
      safecall;
  end;
  ...
  IHxRegisterDisp = dispinterface
    ...
    procedure RemoveHelpFile(const bstrNamespace: WideString;
      const bstrId: WideString; LangId: Integer); dispid 66825;
    procedure RegisterHelpFileSet(const bstrNamespace: WideString;
      const bstrId: WideString; LangId: Integer;
      const bstrHxs: WideString; const bstrHxi: WideString;
      const bstrHxq: WideString; const bstrHxr: WideString;
  ...
  IHxIndex = interface(IDispatch)
    ...
    function GetFullStringFromSlot(iSlot: Integer; const sep: WideString): WideString;
      safecall;
  ...
  IHxSession = interface(IDispatch)
    ...
    function Query(const keywords: WideString; const NavDataMoniker: WideString;
      options: Integer; const FilterMoniker: WideString): IHxTopicList;
      safecall;
    ...
    function QueryForUrl(const keywords: WideString; const NavDataMoniker: WideString;
      options: Integer; const FilterMoniker: WideString): WideString;
      safecall;
  ...
  IHxQuery = interface(IDispatch)
    ...
    function Query(const keywords: WideString; options: HxQuery_Options): IHxTopicList;
      safecall;
    function QueryForTopic(const keywords: WideString;
  ...
  IHxAttrValueList = interface(IDispatch)
    ...
    function EnumAttrValue(filter: Integer; options: Integer): IEnumHxAttrValue;
      safecall;
    function Get__NewEnum: IUnknown; safecall;
  ...
  IHxFiltersDisp = dispinterface
    ...
    procedure RegisterFilter(const bstrName: WideString; const bstrQuery: WideString);
      dispid 66050;
  ...
  IHxRegFilterList = interface(IDispatch)
    ...
    function EnumRegFilter(filter: Integer; options: Integer): IEnumHxRegFilter;
      safecall;
    function Get__NewEnum: IUnknown; safecall;
    function Get_Count: Integer; safecall;
  ...
  IHxSampleCollection = interface(IDispatch)
    ...
    function GetSampleFromId(const bstrTopicUrl: WideString;
      const bstrId: WideString; const bstrSFLName: WideString):
      IHxSample; safecall;
  end;
  ...
  IHxRegNamespaceList = interface(IDispatch)
    ...
    function EnumRegNamespace(filter: Integer; options: Integer): IEnumHxRegNamespace;
      safecall;
    function Get__NewEnum: IUnknown; safecall;
    function Get_Count: Integer; safecall;
    property _NewEnum: IUnknown read Get__NewEnum;
  ...
  IHxRegPlugInList = interface(IDispatch)
    ...
    function EnumRegPlugIn(filter: Integer; options: Integer): IEnumHxRegPlugIn;
      safecall;
    function Get__NewEnum: IUnknown; safecall;
    function Get_Count: Integer; safecall;
    property _NewEnum: IUnknown read Get__NewEnum;
  ...
  IHxRegisterSession = interface(IDispatch)
    ...
    function GetRegistrationObject(type_: HxRegisterSession_InterfaceType): IDispatch;
      safecall;
  end;
  ...
  IHxPlugIn = interface(IDispatch)
    ...
    procedure RegisterHelpPlugIn(const bstrProductNamespace: WideString;
      ...
      const bstrHxa: WideString; options: Integer); safecall;
  ...
  IHxPlugInDisp = dispinterface
    ...
    procedure RegisterHelpPlugIn(const bstrProductNamespace: WideString;
      ...
      const bstrNamespace: WideString;
      const bstrHxt: WideString;
      const bstrHxa: WideString; options: Integer);
      dispid 66304;
    procedure RemoveHelpPlugIn(const bstrProductNamespace: WideString;
      const bstrProductHxt: WideString;
      const bstrNamespace: WideString;
  ...
  IHxSessionEvents = dispinterface
    ...
    procedure QueryCancel(const pSession: IDispatch; const pCancel: IDispatch;
      status: Integer); dispid 65800;
    procedure IndexMergeStatus(const pSession: IDispatch; const pCancel: IDispatch;
      status: Integer); dispid 65801;
    procedure PrintMergeStatus(const pSession: IDispatch; const pCancel: IDispatch;
      status: Integer); dispid 65802;
    procedure MergeIndexFileName(const pDisp: IDispatch; const bstrFile: WideString);
      dispid 65804;
  end;
