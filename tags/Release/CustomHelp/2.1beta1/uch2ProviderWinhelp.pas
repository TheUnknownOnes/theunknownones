...
type
  ...
  private
    ...
    FPriority : Integer;
  public
    constructor Create(AItem : Tch2WinhelpItem; AKeyword : String; APriority : Integer);
...
begin
  for o in Items do
  begin
    AGUI.AddHelpItem(Tch2HIWinhelpItem.Create(i, AKeyword, FPriority));
  end;
end;
...
constructor Tch2HIWinhelpItem.Create(AItem: Tch2WinhelpItem; AKeyword : String; APriority : Integer);
begin
  inherited Create;
...
function Tch2HIWinhelpItem.GetPriority: Integer;
begin
  Result := FPriority;
end;
