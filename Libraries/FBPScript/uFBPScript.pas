...
type
  ...
  public
    ...
    property DefaultQuery: TIBQuery read FDefaultQuery;
...
begin
  ...
  FDefaultDatabase := TIBDatabase.Create(nil);
  FDefaultTransaction := TIBTransaction.Create(FDefaultDatabase);
  FDefaultDatabase.DefaultTransaction := FDefaultTransaction;
  FDefaultTransaction.DefaultDatabase := FDefaultDatabase;
  FDefaultQuery := TIBQuery.Create(FDefaultDatabase);
