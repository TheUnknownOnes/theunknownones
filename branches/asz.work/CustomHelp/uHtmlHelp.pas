...
type
  ...
  tagHH_POPUP = packed record
    ...
    pt: tagPOINT;                             // top center of popup window
    clrForeGround: COLORREF;               // use -1 for default
    clrBackground: COLORREF;               // use -1 for default
    rcMargins: tagRECT;                       // amount of space between edges of window and text, -1 for each member to ignore
...
type
  ...
  tagHH_WINTYPE = packed record
    ...
    rcWindowPos: tagRECT;      // IN: Starting position, OUT: current position
    ...
    rcHTML: tagRECT;           // OUT: HTML window coordinates
